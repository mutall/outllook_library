        ...
        for (const [key, statement] of statements) {
            ...
            do {
                ...
                if (statement.is_empty()) {
                    //
                    //Create a question
                    const Question = new question(key);
                    //
...
export class statement extends outlook.view {
    //
    ...
    async run() {
        ...
        const anchor = this.get_element(this.id);
        //
    ...
    paint() {
        ...
        //
        //The desctinamtion
        const to = [ranix.home, 'interaction'];
        //
...
export class questionnaire extends statement {
    ...
    is_empty() {
        ...
        const anchor = ranix.home.query_selector('[data-cname="reg_no"]');
        //
        //Retrieve the car registration io
        let reg = io.io.get_io(anchor);
        //
    ...
    async check() {
        ...
        if (this.is_empty())
            ...
            if (!await ranix.home.check_inputs())
                return false;
            //
...
export class question extends statement {
    ...
    get response() {
        //
        return ranix.home.get_value('question');
    }
}
